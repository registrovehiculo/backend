...
class UpdateTransporteDatabase(graphene.Mutation):
    ...
    def mutate(self, info):
        try:
            book = xlrd.open_workbook("C:\Transporte\PINAR DEL RIO.xls")
            ...
            book = xlrd.open_workbook("C:\Transporte\ARTEMISA.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\CAMAGUEY.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\CIEGO DE AVILA.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\CIENFUEGOS.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\GRANMA.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\GUANTANAMO.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            for r in range(1, sheet.nrows):
                ...
                cursor.execute(
                    ...
                    [municipio, estado_vehiculo, marca_vehiculo, chapa_nueva, numero_motor,
                     numero_carroseria, marca_motor, numero_identidad, datos_persona, direccion])
            book = xlrd.open_workbook("C:\Transporte\HOLGUIN.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            for r in range(1, sheet.nrows):
                ...
                cursor.execute(
                    ...
                    [municipio, estado_vehiculo, marca_vehiculo, chapa_nueva, numero_motor,
                     numero_carroseria, marca_motor, numero_identidad, datos_persona, direccion])
            book = xlrd.open_workbook("C:\Transporte\ISLA.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            for r in range(1, sheet.nrows):
                ...
                cursor.execute(
                    ...
                    [municipio, estado_vehiculo, marca_vehiculo, chapa_nueva, numero_motor,
                     numero_carroseria, marca_motor, numero_identidad, datos_persona, direccion])
            book = xlrd.open_workbook("C:\Transporte\LAS TUNAS.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            for r in range(1, sheet.nrows):
                ...
                cursor.execute(
                    ...
                    [municipio, estado_vehiculo, marca_vehiculo, chapa_nueva, numero_motor,
                     numero_carroseria, marca_motor, numero_identidad, datos_persona, direccion])
            book = xlrd.open_workbook("C:\Transporte\MATANZAS.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\MAYABEQUE.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            for r in range(1, sheet.nrows):
                ...
                cursor.execute(
                    ...
                    [municipio, estado_vehiculo, marca_vehiculo, chapa_nueva, numero_motor,
                     numero_carroseria, marca_motor, numero_identidad, datos_persona, direccion])
            book = xlrd.open_workbook("C:\Transporte\SANTIAGO DE CUBA.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\S SPIRITUS.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\VILLA CLARA.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            for r in range(1, sheet.nrows):
                ...
                cursor.execute(
                    ...
                    [municipio, estado_vehiculo, marca_vehiculo, chapa_nueva, numero_motor,
                     numero_carroseria, marca_motor, numero_identidad, datos_persona, direccion])
            book = xlrd.open_workbook("C:\Transporte\HABANA1.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            ...
            book = xlrd.open_workbook("C:\Transporte\HABANA2.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            for r in range(1, sheet.nrows):
            ...
            book = xlrd.open_workbook("C:\Transporte\HABANA3.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            for r in range(1, sheet.nrows):
                ...
                cursor.execute(
                    ...
                    [municipio, estado_vehiculo, marca_vehiculo, chapa_nueva, numero_motor,
                     numero_carroseria, marca_motor, numero_identidad, datos_persona, direccion])
            book = xlrd.open_workbook("C:\Transporte\HABANA4.xls")
            print("The number of worksheets is {0}".format(book.nsheets))
            print("Worksheet name(s): {0}".format(book.sheet_names()))
            sheet = book.sheet_by_index(0)
            for r in range(1, sheet.nrows):
